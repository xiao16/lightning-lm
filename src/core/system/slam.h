...
class SlamSystem {
   public:
    ...
    void ProcessLidar(const livox_ros_driver2::msg::CustomMsg::ConstPtr& cloud);
   ...
   private:
    /// ros端保存地图的实现
    bool SaveMapCallback(SaveMapService::Request& request, SaveMapService::Response& response);
