...
class Localization {
   public:
    ...
    void ProcessLivoxLidarMsg(const livox_ros_driver2::msg::CustomMsg::ConstPtr laser_msg);

    /// 处理IMU消息
    void ProcessIMUMsg(IMUPtr imu);

    // void ProcessOdomMsg(const nav_msgs::Odometry::ConstPtr odom_msg) override;
